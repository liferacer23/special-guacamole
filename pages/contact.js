          ...
          <ContactUsForm>
            ...
            >
              ...
              <Flex alignItems="start" justifyContent="center" padding="1rem">
                <Flex direction="column" gap="2rem">
                  <Flex directionMobile="row">
                    ...
                    <Flex
                      ...
                      gap="0px"
                    >
                      <Text mobileFontSize="0.8rem" fontSize="0.8rem">Call us </Text>
                      <Text mobileFontSize="0.8rem"
                        color="rgb(1,44,90)"
                        fontSize="0.8rem"
                        fontWeight="bold"
                      >
                  ...
                  <Flex directionMobile="row">
                    ...
                    <Flex
                      ...
                      gap="0px"
                    >
                      <Text mobileFontSize="0.8rem" fontSize="0.8rem">Email Address </Text>
                      <Text mobileFontSize="0.8rem"
                        color="rgb(1,44,90)"
                        fontSize="0.8rem"
                        fontWeight="bold"
                  ...
                  <Flex directionMobile="row">
                    ...
                    <Flex
                      ...
                      gap="0px"
                    >
                      <Text mobileFontSize="0.8rem" fontSize="0.8rem">Main Office</Text>
                      <Text mobileFontSize="0.8rem"
                        color="rgb(1,44,90)"
                        fontSize="0.8rem"
                        fontWeight="bold"
                ...
                <Flex>
                  <Input size="large" placeholder="Enter your username" suffix={suffix}/>
