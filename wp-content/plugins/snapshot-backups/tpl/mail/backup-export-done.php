                      ...
                      <td align="left" style="font-size:0px;padding:0;word-break:break-word;">
                        <div style="font-family:Roboto, Arial, sans-serif;font-size:18px;letter-spacing:-.25px;line-height:30px;text-align:left;color:#1A1A1A;">
							...
							<ol>
								...
								<?php /* translators: %s - Restore guide URL */ ?>
							</ol>
							<p class="p-30"><?php echo wp_kses_post( sprintf( __( 'For more detailed instructions, check out our <a href="%s" target="_blank">restore guide</a>.', 'snapshot' ), esc_attr( $restore_guide_url ) ) ); ?></p>
							<?php if ( !$is_branding_hidden ) { ?>
