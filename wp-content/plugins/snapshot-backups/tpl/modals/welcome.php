					...
					<ul class="sui-flex justify-evenly apply-config--links">
						<li>
							<span class="sui-flex align-items-center justify-content-center">
								<a href="#" class="sui-welcome-apply-configs" data-nonce="<?php echo esc_attr( wp_create_nonce( 'snapshot-fetch' ) ); ?>"><?php esc_html_e( 'Apply Basic Config', 'snapshot' ); ?></a>
					...
					<form id="snapshot-apply-config--form" method="post">
						...
						<div class="sui-form-field">
							...
							<p id="select-single-icon-helper" class="sui-description" style="margin-top: 10px;">
								<?php esc_html_e( 'Select the Basic Config to apply our Recommended default settings.', 'snapshot' ); ?>
							</p>
						</div>
					</form>
					<hr>
