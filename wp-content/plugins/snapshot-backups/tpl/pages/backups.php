				...
				<table class="sui-table sui-table-flushed sui-accordion">
					<thead>
						<tr class="sui-hidden-xs">
							...
							<th style=" width: 23%; "><?php esc_html_e( 'Frequency', 'snapshot' ); ?></th>
						</tr>
			...
			<div class="sui-box-body">
				...
				<div class="sui-box-settings-row">
					<div class="sui-box-settings-col-1">
						...
						<span class="sui-description"><?php esc_html_e( 'Manually delete all backups of this site stored in WPMU DEV storage.', 'snapshot' ); ?></span>
					</div>
					<div class="sui-box-settings-col-2">
						<div class="sui-form-field">
