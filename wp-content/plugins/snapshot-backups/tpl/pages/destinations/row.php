		...
		<div class="destination-actions">
			...
			<div class="sui-dropdown">
				...
				<ul>
					...
					<li class="destination-view"><a href="<?php echo esc_url($view_url); ?>" <?php if ( '#' !== $view_url && '' !== $view_url ) { echo 'target="_blank" rel="noopener noreferrer"'; } ?>><span class="sui-icon-link" aria-hidden="true"></span> <?php esc_html_e( 'View Directory', 'snapshot' ); ?></a></li>
