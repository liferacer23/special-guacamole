function cymolthemes_imgselector_click(){
	
	jQuery('a.cmt_gallery_widget_add_images').each(function(){
		var $this   = jQuery(this),
			$parent	= jQuery(this).closest('.cmt_image_selector_w'),
			wp_media_frame;
		...
		jQuery($this).on( 'click', function(e){
			...
			wp_media_frame.on( 'select', function() {
				...
				var $input     = jQuery('.cmt_gallery_widget_attached_image_val', $parent);
		...
		jQuery( '.cmt_vc_icon-remove', $parent ).on( 'click', function(e){
			var $input     = jQuery('.cmt_gallery_widget_attached_image_val', $parent);
			e.preventDefault();
