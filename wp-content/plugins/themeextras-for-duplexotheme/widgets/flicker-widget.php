 ...
 * @since 1.0
 */
class duplexo_flicker_widget extends WP_Widget {
	...
	function __construct() {
		$widget_style = array('classname'   => 'duplexo_flicker_widget',
							  'description' => esc_attr__('Show photos from Flickr.','duplexo') );
		...
		$control_styles = array('width'   => 300,
								'height'  => 350,
								'id_base' => 'duplexo_flicker_widget');
		...
		parent::__construct(
			'duplexo_flicker_widget', // Base ID
			esc_attr__('Duplexo Flickr Widget', 'duplexo'), // Name
			$widget_style // Args
		);
	}
	...
	function widget( $args, $cur_instance ) {
		...
		echo '<div class="duplexo_flicker_widget_wrapper">'; ?>
	...
	function form( $cur_instance ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php echo esc_attr__('Title', 'duplexo'); ?>:</label>
...
register_widget( 'duplexo_flicker_widget' );