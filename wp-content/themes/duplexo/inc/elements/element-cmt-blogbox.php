...
$boxParams = cymolthemes_box_params('blog');
...
$allParams = array_merge(
	...
	array(
		array(
			...
			"holder"      => "div",
			"class"       => "",
			"heading"     => esc_attr__("Blogbox Design",'duplexo'),
			"description" => esc_attr__("Select Blogbox design.",'duplexo'),
			"param_name"  => "view",
			"value"       => cymolthemes_global_blog_template_list( true ),
			"std"         => "styleone",
		...
		array(
			...
			"holder"      => "div",
			"class"       => "",
			"heading"     => esc_attr__("Show Posts",'duplexo'),
			"description" => esc_attr__("How many post you want to show.",'duplexo'),
			"param_name"  => "show",
			"value"       => array(
		...
		array(
			...
			"description" => esc_attr__("Show sortable category links above Blog boxes so user can sort by category by just single click.",'duplexo'),
			"param_name"  => "sortable",
			"value"       => array(
		...
		array(
			...
			"description" => esc_attr__("Show pagination links below blog boxes.",'duplexo'),
		...
		array(
			"type"        => "checkbox",
			"heading"     => esc_attr__("From Category", "duplexo"),
			"description" => esc_attr__("If you like to show posts from selected category than select the category here.", "duplexo") . esc_attr__("The brecket number shows how many posts there in the category.", "duplexo"),
			"param_name"  => "category",
			"value"       => $catList,
			'group'		  => esc_attr__( 'Box Style', 'duplexo' ),
		),
...
$cmt_sc_params_blogbox = $params;


vc_map( array(
	"name"     => esc_attr__('CymolThemes Blog Box','duplexo'),
	"base"     => "cmt-sboxblogbox",
	"class"    => "",
