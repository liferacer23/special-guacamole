...
if( taxonomy_exists('cmt_portfolio_category') ){
	$portfolioCatList_data = get_terms( 'cmt_portfolio_category', array( 'hide_empty' => false ) );
	$portfolioCatList      = array();
...
$allParams = array_merge(
		...
		array( 
			array(
				...
				"param_name"  => "view",
				"value"       => cymolthemes_global_portfolio_template_list( true ),
				"std"         => "styleone",
			...
			array(
				...
				"description" => sprintf( esc_attr__("How many %s item you want to show.", "duplexo"), $pf_type_title ),
				"param_name"  => "show",
				"value"       => array(
			...
			array(
				...
				"description" => sprintf( esc_attr__("Show sortable category links above %s items so user can sort by just single click.",'duplexo'), $pf_type_title_singular ),
				"param_name"  => "sortable",
				"value"       => array(
			...
			array(
				...
				"description" => sprintf( esc_attr__("Show pagination links below %s boxes.",'duplexo'), $pf_type_title ),
			...
			array(
				"type"        => "checkbox",
				"heading"     => sprintf( esc_attr__("From %s", "duplexo"), $pf_cat_title_singular ),
				"description" => sprintf( esc_attr__('If you like to show %1$s from selected %2$s than select the category here.', "duplexo"), $pf_type_title, $pf_cat_title ),				
				"param_name"  => "category",
			...
			array(
				...
				"description" => esc_attr__("Sort retrieved portfolio by parameter.",'duplexo'),
				"param_name"  => "orderby",
				"value"       => array(
...
global $cmt_sc_params_portfoliobox;
$cmt_sc_params_portfoliobox = $params;

vc_map( array(
	"name"     => sprintf( esc_attr__("CymolThemes %s Box",'duplexo'), $pf_type_title_singular ),
	"base"     => "cmt-portfoliobox",
	"class"    => "",
