...
/* Options for CymolThemes Testimonial box */

// Fetching all Testmonial group names
$testimonialGroups = array();
if( taxonomy_exists('cmt_testimonial_group') ){
	$testimonial_groups = get_terms( 'cmt_testimonial_group', array('hide_empty'=>false) );
	$testimonialGroups  = array();
 ...
 * Box Design options
 */
$boxParams = cymolthemes_box_params('testimonial');
...
$allParams = array_merge(
	...
	array(
		array(
			...
			"param_name"  => "view",
			"value"       => cymolthemes_global_testimonial_template_list( true ),
			"std"         => "styleone",
		...
		array(
			...
			"param_name"  => "show",
			"description" => esc_attr__("Total Testimonials you want to show.", "duplexo"),
			"value"       => array(
		...
		array(
			...
			"description" => esc_attr__("Show sortable category links above Testimonial boxes so user can sort by category by just single click.",'duplexo'),
			"param_name"  => "sortable",
			"value"       => array(
		...
		array(
			...
			"description" => esc_attr__("Show pagination links below Testimonial boxes.",'duplexo'),
		...
		array(
			...
			"param_name"  => "category",
			"description" => esc_attr__("Select group so it will show Testimonials from selected group only.", "duplexo"),
...
$cmt_sc_params_testimonialbox = $params;


vc_map( array(
	"name"     => esc_attr__("CymolThemes Testimonial Box", "duplexo"),
	"base"     => "cmt-testimonialbox",
