...
get_header(); ?>
	...
	<section id="primary" class="content-area <?php echo cymolthemes_sanitize_html_classes(cymolthemes_sidebar_class('content-area')); ?>">
		...
		<?php if ( have_posts() ) : ?>
			...
			$view   = ( !empty($duplexo_theme_options['pfcat_view']) ) ? $duplexo_theme_options['pfcat_view'] : 'overlay' ;
			$column = ( !empty($duplexo_theme_options['pfcat_column']) ) ? $duplexo_theme_options['pfcat_column'] : 'three' ;
