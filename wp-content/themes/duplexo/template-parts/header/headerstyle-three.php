<header id="cmt-page-header" class="<?php echo cymolthemes_header_style_class(); ?> header-style-four">
	<div class="cmt-header-box <?php echo cymolthemes_headerclass(); ?>">
		<?php get_template_part('template-parts/header/header','floatingbar'); ?>
		<?php get_template_part('template-parts/header/header','topbar'); ?>
		<?php get_template_part('template-parts/header/header','main-three'); ?>
